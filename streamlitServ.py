...
if __name__ == "__main__":
    ...
    uploaded_file = st.file_uploader(label="Supporting file(s)", accept_multiple_files=False,
                                     type=["xls", "xlsx"])
    ...
    if st.button("SUBMIT"):
        ...
        out_table = []
        for userId in stqdm(userList, desc="Generating course progress report.........", mininterval=1):
